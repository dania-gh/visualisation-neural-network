...
int main(int argc, char* argv[]) {
    ...
    SDL_Window* window = SDL_CreateWindow("Interactive Neural Network Visualization", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, width, height, SDL_WINDOW_SHOWN);
    if (!window) {
