...
int main(int argc, char* argv[]) {
    ...
    while (!quit) {
        ...
        } else if (elapsedTime >= duration && elapsedTime < duration + 1000) {
            alpha1 = 70; alpha2 = 255; alpha3 = 70; alpha4 = 70;
        } else if (elapsedTime >= duration + 1000 && elapsedTime < duration + 3000) {
            alpha1 = 70; alpha2 = 70; alpha3 = 255; alpha4 = 70;
        } else if (elapsedTime >= duration + 3000 && elapsedTime < duration + 4000) {
            alpha1 = 70; alpha2 = 70; alpha3 = 255; alpha4 = 70;
        } else if (elapsedTime >= duration + 4000 && elapsedTime < duration + 5000) {
            alpha1 = 70; alpha2 = 255; alpha3 = 70; alpha4 = 70;
        } else if (elapsedTime >= duration + 5000 && elapsedTime < duration + 6000) {
            alpha1 = 255; alpha2 = 70; alpha3 = 70; alpha4 = 70;
        } else {
